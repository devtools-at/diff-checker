...
<p align="center">
  <a href="https://devtools.at/tools/diff-checker"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Compare two texts and find differences</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/diff-checker">Try Online</a> •
...
**[Try Diff Checker online at DevTools.at →](https://devtools.at/tools/diff-checker)**
...
Compare two texts and find differences. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/diff-checker';
